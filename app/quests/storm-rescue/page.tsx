...
const EN = [
  {
    ...
    "verse": "Philippians 4:6 — “Do not be anxious about anything, but in everything by prayer and supplication with thanksgiving let your requests be made known to God.”",
...
const RU = [
  { "id": "dark-clouds", "place": "Маленькая гавань", "title": "Тучи над гаванью", "body": "Мишутка, Рози и Йосик грузят маленькую лодку из игрушечных кирпичиков, когда над водой собираются тёмно-синие тучи. Их младшая подруга Грейси оказалась на маленьком причале по другую сторону бухты.", "caption": "В гавани поднимается ветер, и Грейси нужна помощь через воду.", "danger": "Ветер шепчет: «Сначала паникуй. Потом молись.»", "echo": "Сначала паника...", "thought": "Молись сейчас.", "prompt": "Что Мишутка должен сделать сначала?", "choices": [{ "label": "Помолиться, послушать и осторожно подготовить лодку", "good": true, "response": "Хорошо. Доверие Иисусу помогает Мишутке действовать мудро, а не паниковать." }, { "label": "Кричать на всех, чтобы они поторопились", "good": false, "response": "Страх быстро распространяется, когда мы кричим. Иисус даёт мир и мудрость." }, { "label": "Не обращать внимания на Грейси, потому что буря неудобна", "good": false, "response": "Любовь не уходит от друга, которому нужна помощь." }], "truth": "Я могу молиться до того, как начну паниковать.", "verse": "К Филиппийцам 4:6 — «Не заботьтесь ни о чем, но всегда в молитве и прошении с благодарением открывайте свои желания пред Богом»", "alt": "Мишутка, Рози и Йосик готовят маленькую лодку в гавани под мягкими грозовыми тучами, а Грейси ждёт через бухту" },
...
const ui = {
  "en": {
    ...
    "of": "of",
    "path": "Quest Path",
    "finalVerse": "Peace! Be still!",
    "finalVerseRef": "Mark 4:39",
    "finish": "Finish Quest"
  },
  "ru": {
    ...
    "of": "из",
    "path": "Путь квеста",
    "finalVerse": "Умолкни, перестань.",
    "finalVerseRef": "Марка 4:39",
