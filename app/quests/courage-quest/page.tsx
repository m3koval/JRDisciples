...
const EN: QuestScene[] = [
  {
    ...
    body: 'Michael sees his little sister crying. Her small wooden lamb rolled into the Cave of Echoes. The cave is dark, and everyone says it whispers scary things.',
    caption: 'Michael raises the lamp. The cave waits in the dark.',
    ...
    alt: 'Michael and Rosie at the glowing cave entrance looking for the lost wooden lamb',
  },
  {
    id: 'whispers',
    place: 'The Whispering Tunnel',
    title: 'The cave tells a lie',
    body: 'Michael walks deeper. The walls sparkle like black glass. Suddenly the cave repeats a lie again and again.',
    caption: 'The tunnel sparkles, but the whisper is a lie.',
    danger: '“You are alone… alone… alone…”',
    echo: 'Alone...',
    thought: 'What is true?',
    prompt: 'Which truth should Michael answer with?',
    choices: [
    ...
    alt: 'Michael holding a lantern in the whispering tunnel while golden light pushes back blue shadows',
  },
  {
    id: 'stones',
    place: 'The Cracked Stone Path',
    title: 'One step at a time',
    body: 'Michael finds a path of cracked stones over a deep shadow. He cannot see the whole way, but his lamp shows the next stone.',
    ...
    choices: [
      ...
      { label: 'Sit down forever until fear disappears', good: false, response: 'Fear may not vanish first. With God’s help, Michael can obey while afraid.' },
    ],
    truth: 'God’s Word is a lamp for my path.',
    verse: 'Psalm 119:105 — “Your word is a lamp to my feet and a light to my path.”',
    alt: 'Michael carefully crossing glowing cracked stones with his lantern lighting the next step',
  },
  {
    id: 'rescue',
    place: 'The Deep Chamber',
    title: 'The lost lamb is found',
    body: 'At the deepest part of the cave, Michael sees the wooden lamb stuck between two rocks. The fear echo grows louder than before.',
    ...
    prompt: 'What should Michael remember?',
    choices: [
      { label: '“When I am afraid, I put my trust in You.”', good: true, response: 'Yes. Michael reaches out, rescues the lamb, and turns toward the light.' },
    ...
    verse: 'Psalm 56:3 — “When I am afraid, I put my trust in you.”',
    alt: 'Michael rescuing the wooden lamb in the deep chamber as golden lantern light fills the cave',
  },
]

const RU: QuestScene[] = [
  {
    id: 'entrance', place: 'Вход в пещеру', title: 'Потерянный ягнёнок', body: 'Мишутка видит, что его маленькая сестра плачет. Её деревянный ягнёнок укатился в Пещеру эха. В пещере темно, и все говорят, что она шепчет страшные слова.', caption: 'Мишутка поднимает светильник. Пещера ждёт в темноте.', danger: 'Первое эхо шепчет: «Поверни назад. Тебе слишком страшно».', echo: 'Назад...', thought: 'Сначала молитва?', prompt: 'Что Мишутке сделать сначала?',
    choices: [
    ...
    ], truth: 'Бог помогает мне сделать следующий правильный шаг.', verse: 'Псалом 55:4 — «Когда я в страхе, на Тебя я уповаю».', alt: 'Мишутка и Рози у светящегося входа в пещеру ищут потерянного деревянного ягнёнка',
  },
  {
    id: 'whispers', place: 'Шепчущий туннель', title: 'Пещера говорит ложь', body: 'Мишутка идёт глубже. Стены сверкают, как чёрное стекло. Вдруг пещера повторяет ложь снова и снова.', caption: 'Туннель сверкает, но шёпот говорит ложь.', danger: '«Ты один… один… один…»', echo: 'Один...', thought: 'Что правда?', prompt: 'Какой истиной должен ответить Мишутка?',
    choices: [
    ...
    ], truth: 'Бог со мной в страшных местах.', verse: 'Иисус Навин 1:9 — «Господь Бог твой с тобою везде, куда ни пойдёшь».', alt: 'Мишутка держит светильник в шепчущем туннеле, а золотой свет отгоняет синие тени',
  },
  {
    id: 'stones', place: 'Тропа треснувших камней', title: 'Шаг за шагом', body: 'Мишутка видит каменную тропу над глубокой тенью. Он не видит весь путь, но светильник показывает следующий камень.', caption: 'Освещён только следующий камень. Этого достаточно для одного шага.', danger: 'Эхо говорит: «Если ты не видишь конец пути, лучше остановись».', echo: 'Стой...', thought: 'Следующий шаг?', prompt: 'Какой выбор верный?',
    choices: [
    ...
    ], truth: 'Слово Божие — светильник для моего пути.', verse: 'Псалом 118:105 — «Слово Твоё — светильник ноге моей и свет стезе моей».', alt: 'Мишутка осторожно идёт по светящимся камням, а светильник показывает следующий шаг',
  },
  {
    id: 'rescue', place: 'Глубокий зал', title: 'Ягнёнок найден', body: 'В самой глубокой части пещеры Мишутка видит деревянного ягнёнка между двумя камнями. Эхо страха становится ещё громче.', caption: 'Ягнёнок близко. Страх громче всего перед победой.', danger: '«Ты не справишься. Сдавайся сейчас».', echo: 'Сдавайся...', thought: 'Доверяй Богу.', thoughtSlot: 'bottom-right', prompt: 'Что Мишутке нужно вспомнить?',
    choices: [
      { label: '«Когда я в страхе, на Тебя я уповаю.»', good: true, response: 'Да. Мишутка достаёт ягнёнка и идёт обратно к свету.' },
