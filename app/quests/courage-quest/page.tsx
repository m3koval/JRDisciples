...
const RU: QuestScene[] = [
  {
    id: 'entrance', place: 'Вход в пещеру', title: 'Потерянный ягнёнок', body: 'Майкл видит, что его маленькая сестра плачет. Её деревянный ягнёнок укатился в Пещеру эха. В пещере темно, и все говорят, что она шепчет страшные слова.', caption: 'Майкл поднимает светильник. Пещера ждёт в темноте.', danger: 'Первое эхо шепчет: «Поверни назад. Тебе слишком страшно».', echo: 'Назад...', thought: 'Сначала молитва?', prompt: 'Что Майклу сделать сначала?',
    choices: [
    ...
    ], truth: 'Бог помогает мне сделать следующий правильный шаг.', verse: 'Псалом 55:4 — «Когда я в страхе, на Тебя я уповаю».', alt: 'Майкл и Рози у светящегося входа в пещеру ищут потерянного деревянного ягнёнка',
  },
  {
    id: 'whispers', place: 'Шепчущий туннель', title: 'Пещера говорит ложь', body: 'Майкл идёт глубже. Стены сверкают, как чёрное стекло. Вдруг пещера повторяет ложь снова и снова.', caption: 'Туннель сверкает, но шёпот говорит ложь.', danger: '«Ты один… один… один…»', echo: 'Один...', thought: 'Что правда?', prompt: 'Какой истиной должен ответить Майкл?',
    choices: [
    ...
    ], truth: 'Бог со мной в страшных местах.', verse: 'Иисус Навин 1:9 — «Господь Бог твой с тобою везде, куда ни пойдёшь».', alt: 'Майкл держит светильник в шепчущем туннеле, а золотой свет отгоняет синие тени',
  },
  {
    id: 'stones', place: 'Тропа треснувших камней', title: 'Шаг за шагом', body: 'Майкл видит каменную тропу над глубокой тенью. Он не видит весь путь, но светильник показывает следующий камень.', caption: 'Освещён только следующий камень. Этого достаточно для одного шага.', danger: 'Эхо говорит: «Если ты не видишь конец пути, лучше остановись».', echo: 'Стой...', thought: 'Следующий шаг?', prompt: 'Какой выбор верный?',
    choices: [
    ...
    ], truth: 'Слово Божие — светильник для моего пути.', verse: 'Псалом 118:105 — «Слово Твоё — светильник ноге моей и свет стезе моей».', alt: 'Майкл осторожно идёт по светящимся камням, а светильник показывает следующий шаг',
  },
  {
    id: 'rescue', place: 'Глубокий зал', title: 'Ягнёнок найден', body: 'В самой глубокой части пещеры Майкл видит деревянного ягнёнка между двумя камнями. Эхо страха становится ещё громче.', caption: 'Ягнёнок близко. Страх громче всего перед победой.', danger: '«Ты не справишься. Сдавайся сейчас».', echo: 'Сдавайся...', thought: 'Доверяй Богу.', thoughtSlot: 'bottom-right', prompt: 'Что Майклу нужно вспомнить?',
    choices: [
      { label: '«Когда я в страхе, на Тебя я уповаю.»', good: true, response: 'Да. Майкл достаёт ягнёнка и идёт обратно к свету.' },
    ...
    ], truth: 'Я могу доверять Богу, когда мне страшно.', verse: 'Псалом 55:4 — «Когда я в страхе, на Тебя я уповаю».', alt: 'Майкл спасает деревянного ягнёнка в глубоком зале, а золотой свет наполняет пещеру',
  },
]
