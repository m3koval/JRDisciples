...
const SCENES: Scene[] = [
...

  {
    ...
    hotspots: [
      { id: 1, x: 18, y: 62, r: 8, side: 'right' },
      { id: 2, x: 40, y: 70, r: 8, side: 'right' },
      { id: 3, x: 62, y: 48, r: 8, side: 'right' },
      { id: 4, x: 76, y: 24, r: 8, side: 'right' },
      { id: 5, x: 30, y: 35, r: 8, side: 'right' },
    ],
    diffs: ['Coin pouch appeared for the innkeeper', 'Bandage became brighter', 'Heart of mercy appeared', 'Star appeared above the road', 'Flower bloomed beside the path'],
    diffsRu: ['Появился мешочек монет для гостиницы', 'Повязка стала светлее', 'Появилось сердце милости', 'Звезда появилась над дорогой', 'Цветок расцвёл у пути'],
  },
  {
    id: 'lost-sheep',
    ...
    hotspots: [
      { id: 1, x: 22, y: 72, r: 8, side: 'right' },
      { id: 2, x: 46, y: 38, r: 8, side: 'right' },
      { id: 3, x: 67, y: 58, r: 8, side: 'right' },
      { id: 4, x: 80, y: 28, r: 8, side: 'right' },
      { id: 5, x: 34, y: 24, r: 8, side: 'right' },
    ],
    diffs: ['Flower appeared in the grass', 'Heart appeared near the shepherd', 'Golden bell appeared by the sheep', 'Star appeared in the sky', 'Sunlight grew warmer'],
    diffsRu: ['В траве появился цветок', 'Сердце появилось рядом с пастухом', 'Золотой колокольчик появился у овцы', 'Звезда появилась в небе', 'Свет стал теплее'],
  },
  {
    id: 'daniel-lions',
    ...
    hotspots: [
      { id: 1, x: 25, y: 58, r: 8, side: 'right' },
      { id: 2, x: 50, y: 26, r: 8, side: 'right' },
      { id: 3, x: 72, y: 66, r: 8, side: 'right' },
      { id: 4, x: 38, y: 78, r: 8, side: 'right' },
      { id: 5, x: 64, y: 42, r: 8, side: 'right' },
    ],
    diffs: ['Lion paw mark appeared', 'Light grew brighter above Daniel', 'Heart of trust appeared', 'Stone marker appeared', 'Star appeared near the lion'],
    diffsRu: ['Появился след львиной лапы', 'Свет над Даниилом стал ярче', 'Появилось сердце доверия', 'Появился камень-метка', 'Звезда появилась рядом со львом'],
  },
  {
    id: 'empty-tomb',
    ...
    hotspots: [
      { id: 1, x: 18, y: 70, r: 8, side: 'right' },
      { id: 2, x: 43, y: 54, r: 8, side: 'right' },
      { id: 3, x: 66, y: 36, r: 8, side: 'right' },
      { id: 4, x: 82, y: 72, r: 8, side: 'right' },
      { id: 5, x: 34, y: 26, r: 8, side: 'right' },
    ],
    diffs: ['Garden flower appeared', 'Folded cloth is brighter', 'Resurrection light grew brighter', 'Stone marker appeared', 'Star appeared near the sunrise'],
    diffsRu: ['В саду появился цветок', 'Пелены стали светлее', 'Свет воскресения стал ярче', 'Появился камень-метка', 'Звезда появилась у рассвета'],
  },
]
