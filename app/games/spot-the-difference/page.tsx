...
const SCENES: Scene[] = [
  {
    ...
    hotspots: [
      { id: 1, x: 22, y: 60, r: 8, side: 'right' },
      { id: 2, x: 49, y: 74, r: 8, side: 'right' },
      { id: 3, x: 75, y: 69, r: 8, side: 'right' },
      { id: 4, x: 83, y: 24, r: 8, side: 'right' },
      { id: 5, x: 36, y: 86, r: 8, side: 'right' },

    ],
    diffs: ['One jar changed color', 'Table cloth appeared', 'Fruit appeared on the table', 'Lantern glows brighter', 'New flower bloomed near the jars'],
    diffsRu: ['Один кувшин изменил цвет', 'Появилась скатерть', 'На столе появились фрукты', 'Фонарь светит ярче', 'Новый цветок расцвёл у сосудов'],
  },
  {
    id: 'feeding-5000',
    ...
    hotspots: [
      { id: 1, x: 19, y: 80, r: 8, side: 'right' },
      { id: 2, x: 45, y: 63, r: 8, side: 'right' },
      { id: 3, x: 59, y: 64, r: 8, side: 'right' },
      { id: 4, x: 31, y: 88, r: 8, side: 'right' },
      { id: 5, x: 78, y: 66, r: 8, side: 'right' },

    ],
    diffs: ['Extra basket appeared', 'Extra loaf appeared', 'Extra fish appeared', 'New flower bloomed', 'Jesus’ robe has a warmer patch of light'],
    diffsRu: ['Появилась ещё одна корзина', 'Появился ещё один хлеб', 'Появилась ещё одна рыба', 'Расцвёл новый цветок', 'На одежде Иисуса появился тёплый свет'],
  },
  {
    id: 'calm-storm',
    ...
    hotspots: [
      { id: 1, x: 51, y: 33, r: 8, side: 'right' },
      { id: 2, x: 75, y: 45, r: 8, side: 'right' },
      { id: 3, x: 17, y: 62, r: 8, side: 'right' },
      { id: 4, x: 43, y: 82, r: 8, side: 'right' },
      { id: 5, x: 64, y: 76, r: 8, side: 'right' },

    ],
    diffs: ['Light grew brighter near Jesus', 'Sail cloth changed', 'Lantern became brighter', 'Small stone appeared in the boat', 'Fish appeared near the water'],
    diffsRu: ['Свет возле Иисуса стал ярче', 'Парус изменился', 'Фонарь стал ярче', 'В лодке появился маленький камень', 'У воды появилась рыбка'],
  },
  {
    id: 'zacchaeus',
    ...
    hotspots: [
      { id: 1, x: 24, y: 27, r: 8, side: 'right' },
      { id: 2, x: 51, y: 43, r: 8, side: 'right' },
      { id: 3, x: 64, y: 75, r: 8, side: 'right' },
      { id: 4, x: 39, y: 86, r: 8, side: 'right' },
      { id: 5, x: 82, y: 62, r: 8, side: 'right' },

    ],
    diffs: ['Fruit appeared in the tree', 'New leaf appeared', 'Coins appeared on the road', 'New flower bloomed', 'Small cloth appeared near the wall'],
    diffsRu: ['На дереве появились плоды', 'Появился новый лист', 'На дороге появились монеты', 'Расцвёл новый цветок', 'У стены появилась маленькая ткань'],
  },

  {
    id: 'good-samaritan',
    titleEn: 'The Good Samaritan',
    titleRu: 'Добрый самарянин',
    storyEn: 'A man was hurt on the road, and two people passed by without helping. But a Samaritan stopped, cared for his wounds, and paid for a safe place to rest. Jesus taught that loving your neighbor means showing mercy.',
    storyRu: 'Человек пострадал на дороге, и двое прошли мимо. Но самарянин остановился, перевязал раны и позаботился о нём. Иисус учил: любить ближнего — значит проявлять милость.',
    verseEn: '"You go, and do likewise." — Luke 10:37',
    verseRu: '«Иди, и ты поступай так же.» — Лк 10:37',
    verseRefEn: 'Luke 10:37', verseRefRu: 'Лк 10:37',
    leftBg: 'linear-gradient(135deg,#92400e,#166534)',
    rightBg: 'linear-gradient(135deg,#b45309,#15803d)',
    leftLabel: 'Someone needs help', leftLabelRu: 'Кому-то нужна помощь',
    rightLabel: 'Mercy shown', rightLabelRu: 'Милость показана',
    hotspots: [
      { id: 1, x: 18, y: 86, r: 8, side: 'right' },
      { id: 2, x: 42, y: 69, r: 8, side: 'right' },
      { id: 3, x: 72, y: 82, r: 8, side: 'right' },
      { id: 4, x: 33, y: 88, r: 8, side: 'right' },
      { id: 5, x: 63, y: 43, r: 8, side: 'right' },

    ],
    diffs: ['Coins appeared by the road', 'Bandage cloth became brighter', 'Small basket appeared', 'New flower bloomed', 'Small lantern appeared'],
    diffsRu: ['У дороги появились монеты', 'Повязка стала светлее', 'Появилась маленькая корзина', 'Расцвёл новый цветок', 'Появился маленький фонарь'],
  },
  {
    id: 'lost-sheep',
    titleEn: 'The Lost Sheep',
    titleRu: 'Потерянная овца',
    storyEn: 'Jesus said a good shepherd leaves the ninety-nine sheep and searches for the one that is lost. When he finds it, he rejoices. Jesus seeks and saves people who are lost.',
    storyRu: 'Иисус сказал: добрый пастух оставляет девяносто девять овец и ищет одну потерянную. Когда находит — радуется. Иисус ищет и спасает потерянных.',
    verseEn: '"Rejoice with me, for I have found my sheep that was lost." — Luke 15:6',
    verseRu: '«Порадуйтесь со мною: я нашёл мою пропавшую овцу.» — Лк 15:6',
    verseRefEn: 'Luke 15:6', verseRefRu: 'Лк 15:6',
    leftBg: 'linear-gradient(135deg,#365314,#0c4a6e)',
    rightBg: 'linear-gradient(135deg,#16a34a,#0284c7)',
    leftLabel: 'Searching', leftLabelRu: 'Поиск',
    rightLabel: 'Found and safe', rightLabelRu: 'Найдена и в безопасности',
    hotspots: [
      { id: 1, x: 21, y: 87, r: 8, side: 'right' },
      { id: 2, x: 46, y: 55, r: 8, side: 'right' },
      { id: 3, x: 69, y: 77, r: 8, side: 'right' },
      { id: 4, x: 80, y: 37, r: 8, side: 'right' },
      { id: 5, x: 33, y: 31, r: 8, side: 'right' },

    ],
    diffs: ['New flower bloomed', 'Shepherd cloth changed', 'Small basket appeared', 'New leaf appeared', 'Sunlight grew warmer'],
    diffsRu: ['Расцвёл новый цветок', 'Одежда пастуха изменилась', 'Появилась маленькая корзина', 'Появился новый лист', 'Солнечный свет стал теплее'],
  },
  {
    id: 'daniel-lions',
    titleEn: 'Daniel in the Lions\' Den',
    titleRu: 'Даниил во рву со львами',
    storyEn: 'Daniel kept praying to God even when it was dangerous. God sent His angel and shut the lions\' mouths. Daniel was safe because he trusted God.',
    storyRu: 'Даниил продолжал молиться Богу, даже когда это было опасно. Бог послал ангела и закрыл пасти львов. Даниил был в безопасности, потому что доверял Богу.',
    verseEn: '"My God sent his angel and shut the lions\' mouths." — Daniel 6:22',
    verseRu: '«Бог мой послал Ангела Своего и заградил пасти львов.» — Дан 6:22',
    verseRefEn: 'Daniel 6:22', verseRefRu: 'Дан 6:22',
    leftBg: 'linear-gradient(135deg,#1e293b,#78350f)',
    rightBg: 'linear-gradient(135deg,#312e81,#92400e)',
    leftLabel: 'The den', leftLabelRu: 'Ров',
    rightLabel: 'God protected', rightLabelRu: 'Бог защитил',
    hotspots: [
      { id: 1, x: 24, y: 77, r: 8, side: 'right' },
      { id: 2, x: 51, y: 21, r: 8, side: 'right' },
      { id: 3, x: 72, y: 66, r: 8, side: 'right' },
      { id: 4, x: 39, y: 86, r: 8, side: 'right' },
      { id: 5, x: 64, y: 44, r: 8, side: 'right' },

    ],
    diffs: ['Small stone appeared', 'Light grew brighter above Daniel', 'Cloth changed near the lion', 'New flower bloomed', 'Small lantern appeared'],
    diffsRu: ['Появился маленький камень', 'Свет над Даниилом стал ярче', 'Ткань возле льва изменилась', 'Расцвёл новый цветок', 'Появился маленький фонарь'],
  },
  {
    id: 'empty-tomb',
    titleEn: 'The Empty Tomb',
    titleRu: 'Пустая гробница',
    storyEn: 'On the first day of the week, women came to the tomb and found the stone rolled away. Jesus was not there — He had risen! The empty tomb is good news for the whole world.',
    storyRu: 'В первый день недели женщины пришли ко гробу и увидели: камень отвален. Иисуса там не было — Он воскрес! Пустая гробница — радостная весть для всего мира.',
    verseEn: '"He is not here, for he has risen, as he said." — Matthew 28:6',
    verseRu: '«Его нет здесь — Он воскрес, как сказал.» — Мф 28:6',
    verseRefEn: 'Matthew 28:6', verseRefRu: 'Мф 28:6',
    leftBg: 'linear-gradient(135deg,#475569,#0f766e)',
    rightBg: 'linear-gradient(135deg,#fbbf24,#0f766e)',
    leftLabel: 'Early morning', leftLabelRu: 'Раннее утро',
    rightLabel: 'He is risen', rightLabelRu: 'Он воскрес',
    hotspots: [
      { id: 1, x: 18, y: 82, r: 8, side: 'right' },
      { id: 2, x: 43, y: 68, r: 8, side: 'right' },
      { id: 3, x: 66, y: 39, r: 8, side: 'right' },
      { id: 4, x: 82, y: 78, r: 8, side: 'right' },
      { id: 5, x: 35, y: 58, r: 8, side: 'right' },

    ],
    diffs: ['New flower bloomed', 'Folded cloth became brighter', 'Tomb light grew brighter', 'Small stone appeared', 'Small lantern appeared'],
    diffsRu: ['Расцвёл новый цветок', 'Пелены стали светлее', 'Свет у гробницы стал ярче', 'Появился маленький камень', 'Появился маленький фонарь'],
  },
]
