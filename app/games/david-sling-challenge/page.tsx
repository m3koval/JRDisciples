  ...
  return (
    <main className="dsv2-page">
      <style>{`
        ...
        .dsv2-overlay { position: absolute; z-index: 3; inset: auto 12px 14px 12px; display: flex; gap: 12px; flex-wrap: nowrap; align-items: flex-end; justify-content: space-between; pointer-events: auto; }
        .dsv2-game-btn { pointer-events: auto; flex: 1; border: 0; border-radius: 24px; padding: 18px 16px; min-height: 72px; font-family: var(--font-nunito); font-weight: 1000; font-size: 1rem; color: #3b2307; background: linear-gradient(180deg,#fef3c7,#f59e0b); box-shadow: 0 10px 0 #92400e, 0 20px 30px rgba(0,0,0,.25); cursor: pointer; touch-action: manipulation; }
