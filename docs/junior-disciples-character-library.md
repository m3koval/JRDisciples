# Junior Disciples Character Library

This is the source-of-truth character bible for Junior Disciples children used in quests, homepage art, image prompts, animation prompts, and future story maps.
...
- Michael: primary player character; learns courage by trusting God while afraid.
- Rosie: Michael’s younger sister/friend figure whose wooden lamb rolls into the cave.
- Little Lamb: wooden toy lamb rescue object, not a child character.
- Echoes: fear-lies; not monsters and not children.

### Forgiveness Bridge

- Michael: friend/helper on the bridge quest.
- Rosie: central forgiveness learner; chooses mercy after being hurt.
- Joseph: friend who made the mistake and needs both truth and forgiveness.

### The Forest of Lies

- Michael: steady friend helping test the path.
- Rosie: Scripture-hearted helper who parts twisting vines with truth light.
- Joseph: central truth learner at the forked path and Mirror Lake.
...
Before committing any new quest image pack:

- Compare every scene against this library.
- Fail and regenerate any scene where a child visibly changes age, outfit color, race/skin tone, hair, or role without story reason.
- Fail and regenerate any scene that turns the main children into minifigs/toy characters instead of polished 3D human children.
- Keep readable text out of generated images; render Bible text in the site UI instead.


## Game character asset library

The generated game assets are registered in [the versioned game asset library](../source/character-library/generated-20260924/manifest.json). See [asset status and integration notes](games/character-asset-library.md) before using them. These assets do not replace the visual canon above.
